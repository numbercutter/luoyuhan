    ...
    <section className="max-w-md mx-auto px-6 py-8 md:max-w-lg md:py-12 lg:max-w-2xl lg:py-16">
      <div className="bg-gray-50 rounded-xl p-6 border border-gray-200 md:p-10 lg:p-12">
        ...
        <div className="space-y-4 text-sm leading-relaxed text-gray-700 md:text-base md:space-y-6 lg:text-lg lg:space-y-8">
          <p>
            Digital creator and entrepreneur connecting cultures through travel and fashion. 
            I share my solo travel adventures while running my own fashion brand and 
            international sourcing business.
          </p>
          <p>
            Building authentic connections across the globe, one journey and design at a time.
          </p>
          <div className="pt-6 border-t border-gray-200 md:pt-8 lg:pt-10">
            ...
            <div className="flex flex-wrap gap-2 md:gap-3 lg:gap-4">
              {["Travel Content", "Fashion Brand", "Global Sourcing", "Personal Branding", "Solo Travel"].map((skill) => (
                <span
                  key={skill}
